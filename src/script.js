...
const newspaper1 = new THREE.Mesh(geometry, material);
newspaper1.position.x = newspaper1.position.x + 2;
const newspaper2 = new THREE.Mesh(geometry, material);
newspaper2.position.x = newspaper2.position.x - 2;
